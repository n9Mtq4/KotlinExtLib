...
infix fun Int.maxValueOf(x: Int) = Math.min(this, x)
infix fun Double.maxValueOf(x: Int) = Math.min(this, x.toDouble())
infix fun Long.maxValueOf(x: Int) = Math.min(this, x.toLong())
infix fun Float.maxValueOf(x: Int) = Math.min(this, x.toFloat())
infix fun Int.maxValueOf(x: Double) = Math.min(this, x.toInt())
infix fun Double.maxValueOf(x: Double) = Math.min(this, x)
infix fun Long.maxValueOf(x: Double) = Math.min(this, x.toLong())
infix fun Float.maxValueOf(x: Double) = Math.min(this, x.toFloat())
infix fun Int.maxValueOf(x: Long) = Math.min(this, x.toInt())
infix fun Double.maxValueOf(x: Long) = Math.min(this, x.toDouble())
infix fun Long.maxValueOf(x: Long) = Math.min(this, x)
infix fun Float.maxValueOf(x: Long) = Math.min(this, x.toFloat())
infix fun Int.maxValueOf(x: Float) = Math.min(this, x.toInt())
infix fun Double.maxValueOf(x: Float) = Math.min(this, x.toDouble())
infix fun Long.maxValueOf(x: Float) = Math.min(this, x.toLong())
infix fun Float.maxValueOf(x: Float) = Math.min(this, x.toFloat())

infix fun Int.minValueOf(x: Int) = Math.max(this, x)
infix fun Double.minValueOf(x: Int) = Math.max(this, x.toDouble())
infix fun Long.minValueOf(x: Int) = Math.max(this, x.toLong())
infix fun Float.minValueOf(x: Int) = Math.max(this, x.toFloat())
infix fun Int.minValueOf(x: Double) = Math.max(this, x.toInt())
infix fun Double.minValueOf(x: Double) = Math.max(this, x)
infix fun Long.minValueOf(x: Double) = Math.max(this, x.toLong())
infix fun Float.minValueOf(x: Double) = Math.max(this, x.toFloat())
infix fun Int.minValueOf(x: Long) = Math.max(this, x.toInt())
infix fun Double.minValueOf(x: Long) = Math.max(this, x.toDouble())
infix fun Long.minValueOf(x: Long) = Math.max(this, x)
infix fun Float.minValueOf(x: Long) = Math.max(this, x.toFloat())
infix fun Int.minValueOf(x: Float) = Math.max(this, x.toInt())
infix fun Double.minValueOf(x: Float) = Math.max(this, x.toDouble())
infix fun Long.minValueOf(x: Float) = Math.max(this, x.toLong())
infix fun Float.minValueOf(x: Float) = Math.max(this, x.toFloat())
